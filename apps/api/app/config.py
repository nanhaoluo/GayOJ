...
PRINT_BACKEND = get_env("GAYOJ_PRINT_BACKEND", "file").lower()
PRINT_SPOOL_DIR = get_env("GAYOJ_PRINT_SPOOL_DIR", "")
PRINT_DEFAULT_PRINTER = get_env("GAYOJ_PRINT_DEFAULT_PRINTER", "")
PRINT_COMMAND = get_env("GAYOJ_PRINT_COMMAND", "")
PRINT_COMMAND_TIMEOUT_SECONDS = get_int_env("GAYOJ_PRINT_COMMAND_TIMEOUT_SECONDS", 15)
